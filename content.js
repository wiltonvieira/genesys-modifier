...
//   const containerChatMessages = document.querySelector(".acd-chat-messages");
...
//   observer.observe(containerChatMessages, {
//     attributes: true,
//     childList: true,
//     characterData: true,
//   });
...
// const startObserver = () => {
//   console.log("startObserver");
//   const containerChatMessages = document.querySelector("div.message");

//   if (!containerChatMessages) {
//     console.log("!containerChatMessages: ", containerChatMessages);
//     setTimeout(() => startObserver(), 1000);
//     return;
//   }

//   console.log("Encontrou startObserver: ", containerChatMessages);
